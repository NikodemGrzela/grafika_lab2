...
def startup():
    ...
    vertex_positions = numpy.array([
        ...
        +0.25, -0.25, +0.25, 0.604, 0.075, 0.639,
        -0.25, -0.25, +0.25, 0.604, 0.075, 0.639,
        +0.25, +0.25, +0.25, 0.604, 0.075, 0.639,
...
def render(time):
    ...
    M_matrix = glm.rotate(glm.mat4(1.0), time, glm.vec3(1.0, 0.0, 0.0))

    V_matrix = glm.lookAt(
        glm.vec3(10.0, 20.0, 0.0),
